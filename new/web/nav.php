<div class="bar" data-colapse="false">
    ...
    <div class="button" href="/builder/connect/">
    ...
    <div class="sub">
        <div class="button" href="/branding/logo/">
            <p>Logo Generator</p>
        </div>
        <div class="button" href="/branding/materials/">
            <p>Promotional Materials</p>
        </div>
        <div class="button" href="/branding/post/">
            <p>Posts</p>
        </div>
    </div>
    <div class="button" href="/branding/text/">
        <img src="/assets/icons/message.svg">
        <p>Text Generator</p>
    </div>
    <p>Browse</p>
    <div class="button" href="/templates/">
