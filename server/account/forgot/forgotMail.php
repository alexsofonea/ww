...
function send_confirmaton($name, $to, $code) {
   ...
   <div style="
       ...
       text-align: center;">
      <h1 style="font-family: \'Qartella\';">Reset your ' . $app_name . ' Account Password</h1>
      <h4 style="font-size: 16px; font-family: \'Qartella\'; font-weight: 400;">Hello ' . $name . ', <br /><br /> It seems like you\'ve requested to reset your password for your ' . $app_name . ' account. If you did not make this request, please disregard this email.<h4>
      ...
      <br />
      <h4 style="font-family: \'Qartella\'; font-weight: 400;"><a href="' . $url . '/account/forgot/' . $to . '/' . $code . '" style="font-size: 18px; padding: 10px 15px; border-radius: 10px; background-color: #' . $color . '; color: #000; text-decoration: none;">Reset Password</a><h4>
      <br />
