    ...
    if (selectedElement == null) {
        ...
        if (element.wwEditWidget === undefined) {
            ...
            switch (element.classList[element.classList.length - 1]) {
                case 'wwEditorText':
                    wwEditor.innerHTML = `
                    <img src="/project/admin/assets/icons/editor/up.svg" onclick="moveUp(this)">
                    <img src="/project/admin/assets/icons/editor/down.svg" onclick="moveDown(this)">
                    <img src="/project/admin/assets/icons/editor/duplicate.svg" onclick="duplicate(this)">`;
                ...
                case 'wwEditorImage':
                    ...
                    <div class="version" data-open="false">
                        ...
                        <p class='v' value='' onclick='select(this)'><img src='/project/admin/project/admin/assets/icons/star.svg'> Img</p>
                        <p class='v' value='' onclick='select(this)'><img src='/project/admin/project/admin/assets/icons/star.svg'> Img</p>
                        <p class='v' value='' onclick='select(this)'><img src='/project/admin/project/admin/assets/icons/star.svg'> Img</p>
                        <p class='v' value='' onclick='select(this)'><img src='/project/admin/project/admin/assets/icons/star.svg'> Img</p>
                    </div>`;
                ...
                case 'wwEditorElement':
                    wwEditor.innerHTML = `<img src="/project/admin/assets/icons/editor/up.svg" onclick="moveUp(this)">
                    <img src="/project/admin/assets/icons/editor/down.svg" onclick="moveDown(this)">
                    <img src="/project/admin/assets/icons/editor/duplicate.svg" onclick="duplicate(this)">`;
                    break;
