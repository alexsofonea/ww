        ...
        <div class="row">
            ...
            <script>
                function loadWebEditor() {
                    document.querySelector("#editor").loadSimplePage('/project/admin/cloud/demo/index.php', '<img src="/project/admin/builder/native/iOS.png" class="overlay">');
                }
            </script>
        </div>
