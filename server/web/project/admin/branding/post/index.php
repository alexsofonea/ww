    ...
    <div class="content" id="content">
        ...
        <script>
            async function returnResult() {
                ...
                const response = await fetch(`https://ww.alexsofonea.com/project/admin/lib/backupImage.php?gen=${encodeURIComponent(inputText)}`, {
                    method: 'GET',
                    headers: {
        ...
        <div class="input">
            <input id="input" type="text" placeholder="Describe your new post.">
